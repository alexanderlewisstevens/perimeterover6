...
for a guard theorem using this hybrid parameter. &
...
The question needs lattice-normalized surface area; face-count and
volume-count theorems are separate model cells. &
...
\begin{enumerate}
  ...
  and guard model are fixed.  The current evidence pass found no primary
  source for an $n/8+f/4$ art-gallery theorem or source-stated open problem.
...
normalization, object class, and guard model in 3D.
