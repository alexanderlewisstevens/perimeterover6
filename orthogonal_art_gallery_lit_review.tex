...
sliding-camera and sliding-transmitter visibility, $k$-hop visibility,
polyhypercube point guards, polyhypercube pixel/voxel guards, 3D face guards,
$\pi/2$-edge guards, and 2-reflex reflex-edge guards.  It also records
scope-exclusion cells for floodlight, half-plane,
