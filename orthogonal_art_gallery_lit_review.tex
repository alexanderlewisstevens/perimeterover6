...
main statuses.  The current coverage matrix now separates the cited adjacent
variants that already have source records: two-dimensional edge guards,
sliding-camera and sliding-transmitter visibility, $k$-hop and polyform
visibility, 3D face guards, $\pi/2$-edge guards, and 2-reflex reflex-edge
guards.  It also records scope-exclusion cells for floodlight, half-plane,
